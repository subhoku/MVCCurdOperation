...
<%@page import="com.codeo.servlet.DbConnect"%>
	...
	<div class="container">
		...
		<table class="table mt-4">
			...
			<tbody>
				...
				PreparedStatement ps = conn.prepareStatement("select * from img_details where remark='Inactive'");
				...
				<tr>
					...
					<th scope="row"><img alt="" src="imgs/pdf.png" width="400px"
						height="300px"></th>
